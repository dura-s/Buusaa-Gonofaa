...
export const translations: Record<string, Record<Language, string>> = {
  ...
  contactOfficeAddress: {
    om: "Teessoo Biroo: Adamaa, Oromiyaa, Itoophiyaa. Fuuldura Hoteela Postaa. Lakk. Postaa (P.O. Box): 20118, Adamaa.",
    am: "አድራሻ አዳማ፣ ኦሮሚያ፣ ኢትዮጵያ (ፖስታ ቤት ፊት ለፊት)፤ የፖስታ ሳጥን ቁጥር (P.O. Box): 20118፣ አዳማ።",
    en: "Address: Adama, Oromia, Ethiopia (Opposite Central Post Office Area) | P.O. Box: 20118, Adama."
  },
  contactPhoneLabel: {
    om: "Bilbila Biroo",
    am: "የስልክ መስመር",
